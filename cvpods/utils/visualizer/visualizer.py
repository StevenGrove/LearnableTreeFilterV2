...
class Visualizer:
    ...
    def draw_dataset_dict(self, dic):
        """
        Draw annotations/segmentaions in Cvpack2 Dataset format.
        Args:
            dic (dict): annotation/segmentation data of one image, in Cvpack2 Dataset format.
        Returns:
            output (VisImage): image object with visualizations.
        """
        ...
        for i in range(num_instances):
            ...
            if labels is not None:
                ...
                if boxes is not None:
                    ...
                    text_pos = np.median(masks[i].mask.nonzero(as_tuple=False), axis=1)[::-1]
                    horiz_align = "center"
                else:
