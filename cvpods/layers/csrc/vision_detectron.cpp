...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("refine_backward_edge_weight", &refine_backward_edge_weight, "refine backward wrt edge weight");
  m.def("refine_backward_self_weight", &refine_backward_self_weight, "refine backward wrt self weight");
}
